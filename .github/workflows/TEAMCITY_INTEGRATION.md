...
| `TEAMCITY_BUILD_TYPE_WINDOWS` | TeamCity build configuration ID for Windows builds | `AcfSln_Build_Windows` or `ProjectId_BuildConfigId_Windows` |
| `TEAMCITY_BUILD_TYPE_LINUX` | TeamCity build configuration ID for Linux builds | `AcfSln_Build_Linux` or `ProjectId_BuildConfigId_Linux` |
...
4. Examples:
   - Windows: `AcfSln_CMakeBuild_Windows` or `ImagingTools_AcfSln_Build_Windows`
   - Linux: `AcfSln_CMakeBuild_Linux` or `ImagingTools_AcfSln_Build_Linux`
